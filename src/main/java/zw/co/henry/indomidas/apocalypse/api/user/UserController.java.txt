package zw.co.henry.indomidas.apocalypse.api.user;
...
import zw.co.henry.indomidas.apocalypse.model.user.UserResponse;
...
public class UserController
{
   ...
   public UserResponse getUserInformation(@RequestParam(value = "name", required = false)
   String userIdParam, HttpServletRequest req)
   {
   ...
   public OperationResponse addNewUser(@RequestBody
