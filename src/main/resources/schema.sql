...
name    NVARCHAR(25) NOT NULL DEFAULT 'John Doe',
age    INT(3) NOT NULL DEFAULT 0,
gender   NVARCHAR(6) NOT NULL DEFAULT 'Male',
last_location  NVARCHAR(25) NULL DEFAULT '-17.829167,31.052222',
PRIMARY KEY (id)
);
...
last_location  NVARCHAR(25) NULL,
...
id INT  generated by default as identity,
survivor_id INT NOT NULL,
category  NVARCHAR(25) NOT NULL DEFAULT 'UNKNOWN',
