...
export class ReportsService {
    ...
    getRobotDetails(robotId: number): Observable<any> {
        ...
        const robotDetailSubject = new Subject<any>();
    ...
    getListOfInfectedSurvivors(): Observable<any> {
        return this.apiRequest.get('api/list-of-infected-survivors');
    }

    getListOfNonInfectedSurvivors(): Observable<any> {
        return this.apiRequest.get('api/list-of-non-infected-survivors');
    }

    getPercentageOfInfectedSurvivors(): Observable<any> {
        return this.apiRequest.get('api/percentage-of-infected-survivors');
    }

    getPercentageOfNonInfectedSurvivors() : Observable<any> {
        return this.apiRequest.get('api/percentage-of-non-infected-survivors');
    }
}
