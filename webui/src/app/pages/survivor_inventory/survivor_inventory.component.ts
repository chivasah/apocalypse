...
@Component({
	selector: 'app-survivors-inventory-pg',
	templateUrl: './survivor_inventory.component.html',
    styleUrls: [ './survivor_inventory.scss'],
})

export class SurvivorInventoryComponent implements OnInit {
